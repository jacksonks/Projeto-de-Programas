	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < spw.getEstoque().getProdutos().size();i++){
			if((spw.getEstoque().getProdutos().get(i).valido(spw.getEstoque().getProdutos().get(i).getValidade().getAno(),
				...
				System.out.println(spw.getEstoque().getProdutos().get(i).getProduto().getCodigo()+"  -  "+spw.getEstoque().getProdutos().get(i).getProduto().getNome()+
						"  -  "+spw.getEstoque().getProdutos().get(i).getProduto().getGenero().getNome()+"  -  "+
						spw.getEstoque().getProdutos().get(i).getProduto().getMarca().getNome()+"  -  "+spw.getEstoque().getProdutos().get(i).getProduto().getPreco()+"  -  "+
						spw.getEstoque().getProdutos().get(i).getValidade().toString(spw.getEstoque().getProdutos().get(i).getValidade().getAno(),
								spw.getEstoque().getProdutos().get(i).getValidade().getMes(), spw.getEstoque().getProdutos().get(i).getValidade().getDia())+"  -  "+
